...
Cage should provide reusable packaging/runtime primitives, but public Cage should not ship Office containers or Office recipes. Proprietary/customer recipes need a private or customer-owned home. For Pelagian customer work, that home is `customer-private`.
...
- Office-shaped and proprietary/customer recipes should live under customer/private repositories.
...
Cage remains publicly reusable and application-first while keeping private/proprietary recipes out of the public repo. Nereus can maintain restricted recipe examples and customer-specific app material under `customer-private`.
