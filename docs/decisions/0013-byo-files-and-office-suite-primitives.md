...
Microsoft Office-class apps cannot be treated like ordinary public freeware downloads. Users and businesses may have licensed installers, ISOs, archives, or pre-installed application directories. A full BYO Wine prefix import may be convenient for Bottles/Crossover experiments, but it does not answer the core Cage question: can the application artifact be reproduced from declared source material?

## Decision

Cage now prioritizes reproducible BYO source materialization over prefix-first import:
