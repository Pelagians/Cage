...
- Gate `cage-wine:11.0` CI with `container/common/cage-powershell-runtime-smoke.sh`, which installs the pinned PowerShell MSI in a fresh prefix and requires `PWSH-ALIVE` plus sentinel evidence before Chocolatey work resumes.
