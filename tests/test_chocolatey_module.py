...
class ChocolateyModuleUnitTests(unittest.TestCase):
    ...
    def test_chocolatey_registry_prep_sets_win10_and_upstream_dll_policy(self):
        ...
        self.assertIn("/v mscoree /t REG_SZ /d native,builtin /f", registry)
        self.assertNotIn("/v mscoree /t REG_SZ /d native /f", registry)
        ...
        self.assertIn("AppDefaults\\choco.exe\\DllOverrides' /v mscoree /t REG_SZ /d native,builtin /f", registry)
    ...
    def test_chocolatey_native_promotion_keeps_canonical_choco_gate(self):
        ...
        self.assertIn("mscoree=n,b", promote)
    ...
    def test_chocolatey_package_install_uses_canonical_choco_only(self):
        ...
        self.assertIn("mscoree=n,b", package)
    ...
    def test_chocolatey_diagnostic_writes_json_before_package_install(self):
        ...
        self.assertIn("wineDllOverridesMscoreeNativeBuiltin", diagnostic)
        ...
        self.assertIn('WINEDEBUG=+loaddll timeout "${CAGE_CHOCOLATEY_DEBUG_TIMEOUT:-60s}" wine "$choco_exe_win" --version', diagnostic)
        ...
        self.assertIn("mscoree=n,b", diagnostic)
