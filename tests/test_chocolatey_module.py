...
class ChocolateyModuleUnitTests(unittest.TestCase):
    ...
    def test_chocolatey_dotnet48_is_dedicated_single_msi_step(self):
        ...
        self.assertIn("Action ended .*INSTALL[.] Return value 0", dotnet)
        self.assertIn("dotnet_success_marker=", dotnet)
        self.assertIn("ucrtbase_clr0400.dll", dotnet)
        self.assertIn("ignoring Wine msiexec exit", dotnet)
